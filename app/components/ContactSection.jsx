...
export default function ContactSection() {
  ...
  return (
    <section
      ...
      style={{
        background: 'linear-gradient(135deg, #8B7355 0%, #A0956B 25%, #6B8E7F 50%, #7A8AA0 75%, #8E7A9B 100%)'
      }}
    >
      {/* Floating Elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-stone-100 max-w-3xl mx-auto leading-relaxed">
            Ready to capture your special moments? Let's discuss your photography needs and create something beautiful together.
          </p>
        </motion.div>
