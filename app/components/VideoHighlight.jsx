...
export default function VideoHighlight() {
  return (
    <section className="bg-gradient-to-br from-[#FFF3E0] to-[#FFE0B2] py-20 px-6 mt-0">
...
{/* <video
        ...
        >
          <h2 className="text-4xl md:text-5xl font-extrabold text-[#6A1B1A] mb-6 leading-tight">
            Capture the Event Highlight
          </h2>
          <p className="text-[#4E342E] text-lg md:text-xl mb-8">
